    ...
    <div class="max-w-7xl mx-auto grid grid-cols-4 gap-4">
        <div class="main-left col-span-1">
            <div class="p-4 bg-white border border-gray-200 text-center rounded-lg">
                <img src="https://avatars.githubusercontent.com/u/124286995?v=4" class="mb-6 rounded-full">
                
                <p><strong>Mohamad Anas</strong></p>
        ...
        <div class="main-center col-span-2 space-y-4" >
            <div class="bg-white border border-gray-200 rounded-lg">
                ...
                <div class="p-4 border-t border-gray-50 flex justify-between">
            ...
            <div class="p-4 bg-white border border-gray-200 rounded-lg">
                ...
                <p>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Illo cum, autem dolores culpa nobis quasi architecto sapiente dolorem odio blanditiis.
                </p>
